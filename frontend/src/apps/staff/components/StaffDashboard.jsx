    ...
    try {
      ...
      if (analyticsRes.data.success) {
        ...
        setStats({
          ...
          onlineRevenue: d.online_revenue,
          totalSlots: d.total_slots,
          occupiedSlots: d.occupied_slots,
          currentStaffName: d.current_staff_name
        });
      }
      ...
      setError('Failed to load dashboard data. Please check if the server is running and you are logged in.');
    } finally {
      setLoading(false);
    }
  };
