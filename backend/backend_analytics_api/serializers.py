...
class DashboardSummarySerializer(serializers.Serializer):
    ...
    current_staff_name = serializers.CharField()
...
class CompletedSessionSerializer(serializers.Serializer):
    ...
    amount_paid = serializers.FloatField(source='total_amount_paid')
    payment_status = serializers.CharField()
    is_paid = serializers.BooleanField(source='is_paid_status', default=True)
