...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('backend_core_api', '0002_parkingsession_payment_status'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('favorite_zone', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend_core_api.parkingzone')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('average_duration', models.DurationField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('zone', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='analytics', to='backend_core_api.parkingzone')),
            ],
            options={
